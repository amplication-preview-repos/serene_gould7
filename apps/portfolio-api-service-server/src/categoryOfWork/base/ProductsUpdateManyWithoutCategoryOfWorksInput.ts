...
@InputType()
class ProductsUpdateManyWithoutCategoryOfWorksInput {
...
export { ProductsUpdateManyWithoutCategoryOfWorksInput as ProductsUpdateManyWithoutCategoryOfWorksInput };
