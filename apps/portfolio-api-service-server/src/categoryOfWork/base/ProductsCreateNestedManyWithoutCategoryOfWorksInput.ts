...
@InputType()
class ProductsCreateNestedManyWithoutCategoryOfWorksInput {
...
export { ProductsCreateNestedManyWithoutCategoryOfWorksInput as ProductsCreateNestedManyWithoutCategoryOfWorksInput };
